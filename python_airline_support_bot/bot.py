...
Be professional, empathetic, and helpful. If you don't have specific information about a flight or
policy, let the customer know and suggest they contact the airline directly or check the official website.

When discussing flight information, always provide clear details including flight numbers, times,
gates, and status when available.
            ...
            },
            {
                ...
                "function": {
                    ...
                    "parameters": {
                        "type": "object",
                        "properties": {
                            "departure_city": {"type": "string", "description": "The departure city or airport code"},
                            "arrival_city": {"type": "string", "description": "The arrival city or airport code"},
                        },
...
• Status: {flight.status}"""
        ...
        try:
            if function_name == "get_flight_info":
                ...
                if flight:
                    ...
                    return (
                        f"Flight {flight_number} not found in our system. "
                        f"Please verify the flight number or contact customer service."
                    )
        ...
        try:
            ...
            if response_message.tool_calls:
                ...
                for tool_call in response_message.tool_calls:
                    ...
                    messages.append({"role": "tool", "tool_call_id": tool_call.id, "content": function_result})
            ...
            return (
                ...
                f"Please try again later or contact customer service directly. Error: {str(e)}"
            )
    ...
    def search_flights_by_route(self, departure_city: str, arrival_city: str) -> List[FlightInfo]:
        ...
        for flight in self.flight_database.values():
            if (
                departure_city.lower() in flight.departure_city.lower()
